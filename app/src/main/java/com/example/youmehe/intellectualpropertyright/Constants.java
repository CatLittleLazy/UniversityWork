...
public class Constants {
  ...
  public static String ServiceUrl = "youmehe.wang";

  public static String path = "/universtiyWork/";

  public static String APP_KEY = "";
  public static String APP_ID = "";
  //注册方法
  public static String sign = "http://youmehe.wang/universityWork/user_sign_up.php";
  //检测用户名是否注册
  ...
  //清空购物车
  public static String removeGoodsId = "http://youmehe.wang/universityWork/removeGoodsId.php";
  //结算知识产权服务
  ...
  //上传图片
  public static String uploadImage = "http://youmehe.wang/universityWork/upload_img_test.php";
